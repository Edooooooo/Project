...
screen.title("My Snake Game")  # The Title of Window
screen.tracer(0)  # Turn turtle animation on/off

snake = Snake()  # Snake class
food = Food()  # Food class
scoreboard = ScoreBoard()  # ScoreBoard class for Score
...
while game_is_on:
    ...
    for segment in snake.segments[2:]:  # Slicing, it's for first 3 segments (squares)
